...
This specification defines `phenix.nvim` as a Neovim frontend for the Phenix conductor. Runtime semantics are defined canonically by `phenix-conductor`'s typed protocol, domain implementation, and runtime documentation. This document specifies only frontend responsibilities and conformance.
